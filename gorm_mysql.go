...
func (this *Register) RunDatabase() {
	dsn := library.Config.Database.User + ":" + library.Config.Database.Password + "@tcp(" + library.Config.Database.Host + ":" + library.Config.Database.Port + ")/" + library.Config.Database.Name + "?charset=utf8mb4&parseTime=True&loc=" + url.QueryEscape(library.Config.App.TimeZone)
