...
func (this *logrus) Panic(args ...interface{}) {
	...
	go this.logToKv("[PANIC]", time.Now().Format("2006-01-02 03:04:05"), Config.Service.RpcId + ": ", args)
	return
}
...
func (this *logrus) Fatal(args ...interface{}) {
	...
	if Instance_Logrus.Level >= Package_Logrus.FatalLevel {
		go this.logToKv("[FATAL]", time.Now().Format("2006-01-02 03:04:05"), Config.Service.RpcId + ": ", args)
	}
	return
}
...
func (this *logrus) Error(args ...interface{}) {
	...
	if Instance_Logrus.Level >= Package_Logrus.ErrorLevel {
		go this.logToKv("[ERROR]", time.Now().Format("2006-01-02 03:04:05"), Config.Service.RpcId + ": ", args)
	}
	return
}
...
func (this *logrus) Warning(args ...interface{}) {
	...
	if Instance_Logrus.Level >= Package_Logrus.WarnLevel {
		go this.logToKv("[WARNING]", time.Now().Format("2006-01-02 03:04:05"), Config.Service.RpcId + ": ", args)
	}
...
func (this *logrus) Info(args ...interface{}) {
	...
	if Instance_Logrus.Level >= Package_Logrus.InfoLevel {
		go this.logToKv("[INFO]", time.Now().Format("2006-01-02 03:04:05"), Config.Service.RpcId + ": ", args)
	}
...
func (this *logrus) Debug(args ...interface{}) {
	...
	if Instance_Logrus.Level >= Package_Logrus.DebugLevel {
		go this.logToKv("[DEBUG]", time.Now().Format("2006-01-02 03:04:05"), Config.Service.RpcId + ": ", args)
	}
...
func (this *logrus) Trace(args ...interface{}) {
	...
	if Instance_Logrus.Level >= Package_Logrus.TraceLevel {
		go this.logToKv("[TRACE]", time.Now().Format("2006-01-02 03:04:05"), Config.Service.RpcId + ": ", args)
	}
